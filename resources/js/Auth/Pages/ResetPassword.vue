    ...
    <div class="conteiner relative">
        ...
        <div v-if="!formSent" class="flex items-center justify-center h-screen max-w-xs mx-auto">
            <div class="p-3 border rounded-md border-gray-200 shadow-md w-full">
                ...
                <div class="text-center text-xl">Reset password</div>
                ...
                <form class="mt-5">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="password" id="password_confirmation"
                            class="p-2 border rounded-sm shadow-sm block w-full" v-model="password_confirmation"
                            required>
                    </div>
        ...
        <p v-else class="text-center mt-20 text-xl">{{formSent}}</p>
        ...
        axios.post('/api/reset-password', {
            ...
            .then(response => {
                ...
                if (response.data.success) {
                    formSent.value=response.data.data.status;
